...
enum Motor {
	FRONT_LEFT, FRONT_RIGHT, BACK_LEFT, BACK_RIGHT, CLIMB_LEFT, CLIMB_RIGHT,
	FRONT_LEFT, FRONT_RIGHT, BACK_LEFT, BACK_RIGHT, INTAKE, INTAKE_LIFTER,
	FRONT_LEFT, FRONT_RIGHT, BACK_LEFT, BACK_RIGHT, FLYWHEEL, FEEDER,
	MOTOR_COUNT
};
